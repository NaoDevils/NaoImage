...
if [ -z "$FRAMEWORK_DIR" ]; then
	rm -rf ./root.tgz
	./generate_image.sh "$INPUT_OPN" "image.ext3" ubuntu firmware-update naodevils-framework-base joystick save-base
	...
	./generate_image.sh "$INPUT_OPN" "image.ext3" ubuntu firmware-update naodevils-framework-base joystick save-base naodevils-robotconfig naodevils-framework-copy
